...
locals {
    ...
    sed -i s,DNS_CLUSTER_IP,$DNS_CLUSTER_IP,g /etc/systemd/system/kubelet.servce
    sed -i s,CERTIFICATE_AUTHORITY_FILE,$CERTIFICATE_FILE_PATH,g /var/lib/kubelet/kubeconfig
